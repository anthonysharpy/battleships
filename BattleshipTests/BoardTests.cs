...
";
    ...
    public void TryAddShip_DoesntAllowOverlappingShips()
    {
        ...
        Ship ship = new(Vector2Int.ParseVector2Int("B5"), new ShipDefinition(5, "Test"), ShipOrientationType.Horizontal);
        Assert.IsTrue(board.TryAddShip(ship));

        Ship ship2 = new(Vector2Int.ParseVector2Int("E6"), new ShipDefinition(4, "Test"), ShipOrientationType.Vertical);
        Assert.IsTrue(board.TryAddShip(ship2));

        Ship ship3 = new(Vector2Int.ParseVector2Int("F5"), new ShipDefinition(4, "Test"), ShipOrientationType.Horizontal);
        Assert.IsFalse(board.TryAddShip(ship3));

        Ship ship4 = new(Vector2Int.ParseVector2Int("A5"), new ShipDefinition(4, "Test"), ShipOrientationType.Vertical);
